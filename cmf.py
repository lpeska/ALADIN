...
class CMF:
    ...
    def learn_hyperparameters(self, intMat, drugMat, targetMat, seed=500):    
        ...
        params = cv_eval.cmf_cv_eval("cmf", "","", cv_data_optimize_params, intMat, drugMat, targetMat, 1, "") 
        self.K = params["d"]
        self.lambda_l = params["x"]
        self.lambda_d = params["y"] 
        self.lambda_t = params["z"] 
    ...
    def fix_model(self, W, intMat, drugMat, targetMat, seed):
        ...
        if self.hyperParamLearn == False:
            self.learn_hyperparameters( WR, drugMat, targetMat)      
